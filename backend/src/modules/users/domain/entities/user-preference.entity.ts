...
export interface UserPreferenceProps {
    ...
    // Health compatibility preferences
...
export class UserPreference {
    ...
    constructor(props: UserPreferenceProps) {
        this._props = {
            ...
            infectiousPreference: props.infectiousPreference ?? HealthConditionPreference.NO_PREFERENCE,
    ...
    get preferredGender(): string[] { return [...(this._props.preferredGender || [])]; }
    ...
    get diabeteBpPreference(): HealthConditionPreference | undefined { return this._props.diabeteBpPreference; }
    ...
    get disablilityPreferece(): HealthConditionPreference | undefined { return this._props.disablilityPreferece; }
