        ...
        <>
                ...
                <div className={styles.modalOverlay}>
                    <div className={styles.modalContainer}>
                        ...
                        <div className={styles.modalContent}>
                            ...
                            <h2 className={styles.modalTitle}>Verifying Identity</h2>
            ...
            <div className={styles.container}>
                <div className={styles.leftPanel}>
                    ...
                    <h1 className={styles.mainTitle}>Review Verification</h1>
                    ...
                    <div className={styles.checklistCard}>
                        <div className={styles.checklistItem}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="9 12 11 14 15 10"></polyline></svg>
                    ...
                    <div className={styles.securityCard}>
                        <div className={styles.securityHeader}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                            <h3>Your Information Is Protected</h3>
                        </div>
                        <ul className={styles.securityList}>
                            <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> Encrypted Storage</li>
                            <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg> Private Verification</li>
                            <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> Safer Community</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className={styles.rightPanel}>
                    <div className={styles.glassCard}>
                        ...
                        <div className={styles.docPlaceholder}>
                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        </div>
                    </div>
                    ...
                    <div className={styles.glassCardSmall}>
                        <div className={styles.selfieContent}>
                            <div className={styles.selfieAvatar}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                            </div>
                        ...
                        <div className={styles.livenessGrid}>
                            {livenessResults.map((result, idx) => (
                                <div key={idx} className={styles.livenessItem}>
                                    ...
                                    <span>{result.prompt.replace('_', ' ')}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className={styles.infoBanner}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                        <span>Once submitted, your verification will be processed automatically. Some submissions may require manual review.</span>
                    </div>

                    <div className={styles.actionFooter}>
                        <button className={styles.secondaryBtn} disabled={isLoading}>
                            <span>Back</span>
                        </button>
                        <button onClick={handleSubmit} className={styles.primaryBtn} disabled={!consentChecked || isLoading}>
                            <span>{isLoading ? "Submitting..." : "Submit Verification →"}</span>
                        </button>
                    </div>
                </div>
            </div>
