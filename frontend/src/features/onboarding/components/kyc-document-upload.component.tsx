...
export const KycDocumentUpload = () => {
    ...
    const handleSubmit = async(e: React.FormEvent<HTMLFormElement>) => {
        ...
        if(documentType === 'AADHAAR_XML' && shareCode.length !== 4){
        ...
        <div className={styles.container}>
            <div className={styles.leftPanel}>
                ...
                <div className={styles.featuresGrid}>
                    <div className={styles.featureCard}>
                        <div className={styles.iconWrapper}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                        </div>
                        <div>
                ...
                <div className={styles.securityBanner}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                ...
                <div className={styles.glassCard}>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit}>
                        ...
                        <div className={styles.formFooterBanner}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                        ...
                        <div className={styles.buttonWrapper}>
                            <button type="submit" className={styles.primaryBtn} disabled={isLoading}>
                                <span>{isLoading ? "Running PKI Validation..." : "Continue →"}</span>
                            </button>
                        </div>
                    </form>
                </div>
