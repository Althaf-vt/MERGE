        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.card}>
                <div className={styles.errorReasonHeader}>
                    <div className={styles.errorIconBox}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#DC2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line><path d="M9 16l2 2 4-4"></path></svg>
                    </div>
                    <div>
            ...
            <div className={styles.infoBoxGrey}>
                <h4 className={styles.tipsTitle}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6D28D9" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                    Tips Before Retrying
                </h4>
                <ul className={styles.tipsList}>
                    <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Use a clearer image without glare or blur</li>
                    <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Ensure good, natural lighting</li>
                    <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Keep your face fully visible and centered</li>
                    <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Upload the correct, unexpired document</li>
                    <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Complete all liveness tasks carefully</li>
                </ul>
            </div>

            <div className={styles.actionGroup}>
                <button onClick={handleRetry} className={styles.primaryBtn}><span>Retry Verification</span></button>
