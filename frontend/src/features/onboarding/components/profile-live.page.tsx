// frontend/src/features/onboarding/pages/profile-live.page.tsx
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.subtitle}>
          ...
          To unlock matchmaking, let's complete your behavioral interview.
        </p>

        <div className={styles.actionGroup}>
            <Link to="/casting-director" className={styles.primaryBtn}>
                <span>
